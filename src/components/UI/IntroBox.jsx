...
export default function IntroBox() {
  return (
    <div className="p-[1vw] bg-white absolute inset-1/2 translate-x-[-50%] translate-y-[-50%] h-fit w-[27vw] rounded-bl-[5vw] ">
      <div className="h-full flex flex-col items-center justify-center text-center gap-[.5vw]   w-full pb-[2vw]  text-green-800 border-zinc-200 border rounded-bl-[5vw]">
        ...
        <p className="font-black text-[1.1vw] tracking-tight w-full text-green-800"> Our CCUS mission</p>
        ...
        <div className="flex items-center mt-[1.2vw] cursor-pointer w-fit justify-center gap-[1vw] bg-[#E6E6DF] rounded-full p-[.3vw]">
          <div className="bg-[#00DD39] p-[1vw] rounded-full">
            <svg
